...
{
  "displayName": "Ladenzeile Landing Tag",
  "description": "The Ladenzeile Landing Tag is used to store the unique click information, which is used later for the conversion tracking.",
  "categories": [
    "CONVERSIONS"
  ],
  "type": "TAG",
